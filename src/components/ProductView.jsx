    ...
    <section>
      <div className="flex flex-col gap-14 xl:flex-row items-center xl:items-start">
        ...
        <div className="flex flex-col xl:flex-[1.5]">
          ...
          <div className="flex gap-x-2 text-gray-400 medium-22">
            <MdStar />
            <MdStar />
            <MdStar />
            <MdStar />
          ...
          <div className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
            <button
              ...
              className="btn_dark_rounded !rounded-none uppercase regular-14 tracking-widest hover:bg-primary hover:text-black"
            >
              Add to cart
            </button>
